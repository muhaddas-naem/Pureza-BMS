    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredCustomers.map((cust) => {
          ...
          const recognizedCustOrders = custOrders.filter(
            (o) => o.orderStatus === 'Shipped' || o.orderStatus === 'Delivered' || o.orderStatus === 'Completed'
          );
          const totalSpent = recognizedCustOrders.reduce((acc, o) => acc + o.grandTotal, 0);
          const avgOrder = recognizedCustOrders.length > 0 ? totalSpent / recognizedCustOrders.length : 0;
